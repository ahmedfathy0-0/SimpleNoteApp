...
<div class="max-w-lg mx-auto mt-8 bg-gray-800 rounded-lg shadow p-8">
  ...
  <?php if ($success): ?>
    <div class="mb-4 p-3 rounded bg-green-700 text-white">Registration successful! <a href="/signin" class="underline">Sign in</a></div>
  <?php endif; ?>
  <?php if ($error): ?>
  ...
  <form method="post" action="/signup">
    ...
    <div class="mb-4">
      ...
      <input type="email" id="email" name="email" class="w-full px-3 py-2 rounded bg-gray-900 text-white border border-gray-700" required>
    </div>
    <div class="mb-4">
    ...
    <button type="submit" class="bg-indigo-500 hover:bg-indigo-400 text-white font-semibold px-4 py-2 rounded">Sign Up</button>
  </form>
  <div class="mt-4 text-gray-400">
    Already have an account? <a href="/signin" class="text-indigo-400 underline">Sign in</a>
  </div>
</div>
<?php
